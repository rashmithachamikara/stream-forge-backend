# Stream Forge Database Schema v2.0

**Version:** 2.0  
**Date:** June 2, 2026  
**Status:** Updated - Upload Sessions and Upload Configuration Added
...
11. `Bookmarks.UserId` - User bookmarks
...
### Composite Indexes
15. `Bookmarks (UserId, VideoId)` (UNIQUE) - Prevent duplicates
